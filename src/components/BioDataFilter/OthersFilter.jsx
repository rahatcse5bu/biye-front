  ...
  useEffect(() => {
    ...
    setCategories((previous) => {
      const updated = previous.filter(
        (value) => !["নওমুসলিম", "মাসনা হতে আগ্রহী", "তাবলীগ"].includes(value)
      );

      if (updated.length !== previous.length) {
        setFilterFields((fields) => ({
          ...fields,
          categories: updated.length ? updated.join(",") : undefined,
        }));
      }
      ...
      <div className="py-5">
        ...
        <div className="grid grid-cols-2">
          ...
          <CustomCheckboxOption
            ...
            onChange={(e) =>
              handleEconomicStatusChange("উচ্চবিত্ত", e.target.checked)
            }
          />
          <CustomCheckboxOption
            id="upperMiddleClass"
            ...
            onChange={(e) =>
              handleEconomicStatusChange("উচ্চ মধ্যবিত্ত", e.target.checked)
            }
          />
          <CustomCheckboxOption
            id="middleClass"
            ...
            onChange={(e) =>
              handleEconomicStatusChange("মধ্যবিত্ত", e.target.checked)
            }
          />
          <CustomCheckboxOption
            id="lowerMiddleClass"
            ...
            onChange={(e) =>
              handleEconomicStatusChange("নিম্ন মধ্যবিত্ত", e.target.checked)
            }
          />
          <CustomCheckboxOption
            id="lowerClass"
            ...
            onChange={(e) =>
              handleEconomicStatusChange("নিম্নবিত্ত", e.target.checked)
            }
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2">
          <CustomCheckboxOption
            ...
            onChange={(e) =>
              handleCategoriesChange("প্রতিবন্ধী", e.target.checked)
            }
          />
          <CustomCheckboxOption
            id="infertile"
            ...
            onChange={(e) =>
              handleCategoriesChange("বন্ধ্যা", e.target.checked)
            }
          />
          {showIslamicOptions && (
            <CustomCheckboxOption
              ...
              onChange={(e) =>
                handleCategoriesChange("নওমুসলিম", e.target.checked)
              }
            />
          )}
          <CustomCheckboxOption
          ...
          {showIslamicOptions && (
            <>
              <CustomCheckboxOption
                ...
                onChange={(e) =>
                  handleCategoriesChange("মাসনা হতে আগ্রহী", e.target.checked)
                }
              />
              <CustomCheckboxOption
                id="tabligh"
                ...
                onChange={(e) =>
                  handleCategoriesChange("তাবলীগ", e.target.checked)
                }
              />
            </>
          )}
