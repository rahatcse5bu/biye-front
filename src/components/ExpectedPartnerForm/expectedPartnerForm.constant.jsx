...
export const screenColorOptionsMultiple = [
  { value: 'কালো', label: 'কালো' },
  { value: 'শ্যামলা', label: 'শ্যামলা' },
  { value: 'উজ্জল শ্যামলা', label: 'উজ্জল শ্যামলা' },
  { value: 'ফর্সা', label: 'ফর্সা' },
  { value: 'উজ্জল ফর্সা', label: 'উজ্জল ফর্সা' },
];

export const educationOptionsMultiple = [
  {
    value: 'হাফেজ',
    label: 'হাফেজ',
  },
...
export const maritalStatusMultiple = [
...
export const professionMultiple = [
...
export const financialOptionsMultiple = [
